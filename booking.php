                                ...
                                if ($seat > 0) {
                                    ...
                                    echo 'No Seat';
                                            ...
                                            ?></td>
                                                ...
                                                <td class="grid_label"><a href="book_second.php?rid=<?php echo $row ['route_id']; ?>&tid=<?php echo $row ['id']; ?>&tclass=<?php echo $tclass; ?>&seat=<?php echo $seat; ?>&journey_date=<?php echo $tdate; ?>">Book</a></td>                            
                                            </tr>
                                            <?php
                                        }
                                    } else {
