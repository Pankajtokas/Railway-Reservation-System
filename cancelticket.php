...
if (!empty($user_id)) {
    ...
    <html>
        <head>
            <title>Canceled Ticket - Railway Reservation System</title>
                    ...
                    <div class="col-md-8">
                        ...
                        <form class="form-light mt-20" role="form" method="post" action="">
                            <table class="table_list">                               
                                ...
                                <?php
                                $i = 0;
                                $sql = "SELECT r.source,r.destination,t.train_no,t.train_name,b.pnr_no,b.no_of_seat,b.booking_amount,b.booking_status,b.journey_date,b.booking_class,b.id FROM trains t JOIN routes r ON r.id = t.route_id JOIN booking b ON b.train_id = t.id WHERE b.user_id = '" . $user_id . "' AND b.booking_status IN ('Cancelled')";
